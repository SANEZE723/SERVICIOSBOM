...
import { TrashIcon, PlusCircleIcon, PencilIcon, XCircleIcon, GripVerticalIcon, ArrowLeftIcon, ArrowRightIcon, KeyIcon } from './icons';
        ...
        <div className="bg-gray-800/60 rounded-xl shadow-lg p-6">
            ...
            <form onSubmit={handlePasswordChange} className="space-y-4 max-w-lg">
                ...
                <div>
                    <button
                        type="submit"
                        className="w-full flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-500 rounded-md text-white font-semibold transition-colors mt-2"
                    >
                        Cambiar Contraseña
                    </button>
                </div>
